...
WATERMARK_POSITION_CUSTOM = "自定义"
WATERMARK_POSITION_TILE = "平铺"
WATERMARK_POSITIONS = [
    "左上",
    "上中",
    "右上",
...
DEFAULT_WATERMARK_OFFSET_X = 0
DEFAULT_WATERMARK_OFFSET_Y = 0
DEFAULT_WATERMARK_TILE_SPACING_X = 80
DEFAULT_WATERMARK_TILE_SPACING_Y = 80
DEFAULT_WATERMARK_TILE_OFFSET_X = 40
DEFAULT_WATERMARK_TILE_OFFSET_Y = 40
WATERMARK_COLORS = {
    "灰色": (102, 102, 102),
    "白色": (255, 255, 255),
    "黑色": (0, 0, 0),
